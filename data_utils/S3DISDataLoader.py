...
class S3DISDataset(Dataset):
    def __init__(self, split='train', data_root='trainval_fullarea', num_point=4096, test_area=5, block_size=1.0, sample_rate=1.0, transform=None):
        ...
        # self.room_idxs=self.room_idxs[:100]
    ...
    def __getitem__(self, idx):
        ...
        # pcd.colors = open3d.utility.Vector3dVector(points[:, 3:]/255)
        # open3d.io.write_point_cloud('1.ply',pcd)
        # print(points[0,3:],points[0,3:]/255)
...
if __name__ == '__main__':
    data_root = '/home/sunjianwen/Pointnet_Pointnet2_pytorch/data/stanford_indoor3d'
